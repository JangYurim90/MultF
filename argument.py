...
##
    ...
    parser.add_argument('--HCPdata_dir', type=str, default='/camin1/yrjang/HCP_data',
                        help='HCP dataset_directory')
    parser.add_argument('--loss_dir', type=str, default='/camin1/yrjang/Brain_network_dynamics/Dynamics_RNN/epoch_adjust',
                        help='HCP dataset_directory')
    parser.add_argument('--test_dir', type=str, default='model_2025-07-09_03-26-15',help='model parameter for test')
    ...
    parser.add_argument('--lambda_r', type=float, default=0.2)
    parser.add_argument('--other_data', type=str, default='HCP')
    
    # sliding window arguments
    parser.add_argument('--i_win', type=int, default=50, 
                        help="number of timepoints of input window")
    parser.add_argument('--o_win', type=int, default=2, 
