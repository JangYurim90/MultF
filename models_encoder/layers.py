...
from models_encoder.ML_model import MultiLinearRegression
...
class CustomTransformerEncoderLayer(nn.Module):
    def __init__(self, d_model, n_heads, dim_feedforward, dropout=0.1, activation='tanh'):
...
class TSTransformerEncoder(nn.Module):
    ...
    def __init__(self, feat_dim, max_len, d_model, n_heads, num_layers, dim_feedforward ,linear_hidden, output_length=10, dropout=0.1,
        ...
        #self.linear1 = nn.Linear(d_model, feat_dim)
        self.multi_linear_reg = MultiLinearRegression(d_model, linear_hidden, feat_dim)
    ...
    def forward(self, X, padding_masks):
        ...
        # Select the last output_length timepoints for prediction
